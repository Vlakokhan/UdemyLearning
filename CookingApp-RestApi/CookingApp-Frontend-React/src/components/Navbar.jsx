          ...
          <AppBar position="static" style={{ background: '#ADD8E6' }}>
            <Toolbar variant="dense">
              ...
              <Box sx={{ m: 0.5, mx: 'auto', width: 100 }}>
                <Button variant="outlined" href='http://localhost:3000/create'>Add Dish</Button>
              </Box>
              <Box sx={{ m: 0.5, mx: 'auto', width: 180 }}>
                <Button variant="outlined" href='https://www.linkedin.com/in/vladyslavkokhan/'>Contact Us</Button>
               </Box>
        </Toolbar>
      </AppBar>
    </Box>
